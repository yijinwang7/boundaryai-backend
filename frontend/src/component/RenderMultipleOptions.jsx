  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center">
        <div className="w-[22px] h-[22px] border-2 rounded-full border-[#6851a7]" />
        {option && (
          <motion.div 
            initial={{ scale: 0.5 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.15 }}
            className="absolute w-[10px] h-[10px] rounded-full bg-[#6851a7]" 
          />
        )}
      </div>
...
export default RenderMultipleOptions;
